      ...
      <div class="header-body">
        <div class="row align-items-center py-4">
          <div class="col-lg-6 col-7">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item"><a href="{{ route('que2.index') }}">Que 2</a></li>
          ...
          <div class="col-lg-6 col-5 text-right">
            ...
            <a href="{{ route('que2moved') }}" class="btn btn-sm btn-neutral">QUEUE 2 MOVE LIST</a>
          </div>
        </div>
      </div>
    </div>
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td class="td-actions text-right">
                     ...
                     <form id="delete-form-{{ $wait->id }}" action="{{ route('que2.destroy', $wait->id) }}" method="POST" class="d-none">
                         @csrf
                         @method('DELETE')
                     </form>

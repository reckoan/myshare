      ...
      <div class="header-body">
        <div class="row align-items-center py-4">
          ...
          <div class="col-lg-6 col-5 text-right">
            ...
            <a href="{{ route('que6moved') }}" class="btn btn-sm btn-neutral">QUEUE 6 MOVE LIST</a>
          </div>
        </div>
      </div>
    </div>
                ...
                @foreach ($que6 as $index => $wait)
                  <tr>
                      ...
                      <td class="td-actions text-right">
                       ...
                       <form id="delete-form-{{ $wait->id }}" action="{{ route('que6.destroy', $wait->id) }}" method="POST" class="d-none">
                           @csrf
                           @method('DELETE')
                       </form>

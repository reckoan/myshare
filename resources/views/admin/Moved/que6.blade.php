          ...
          <div class="col-lg-6 col-7">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item"><a href="{{ route('que6.index') }}">Que6</a></li>
                <li class="breadcrumb-item active" aria-current="page">Queue 6</li>
              </ol>
            </nav>
          </div>
          <div class="col-lg-6 col-5 text-right">
            <a href="{{ route('que7.index') }}" class="btn btn-sm btn-neutral">QUEUE 7 </a>
            <a href="{{ route('que6.index') }}" class="btn btn-sm btn-neutral">BACK TO QUE 6</a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="card">
          ...
          <div class="table-responsive">
            ...
            <table class="table">
              ...
              <tbody>
                @foreach ($que6moved as $index => $wait)
                  <tr>
                    ...
                    <div class="form-group">
                      ...
                      <button class="btn btn-success btn-md btn-block" type="submit">Submit</button>
                              ...
                              <div class="modal-footer">
                                ...
                                <a class="btn btn-info" href="{{ route('que6moved.update6', $wait->id) }}"
                       ...
                       <form id="delete-form-{{ $wait->id }}" action="{{ route('que6moved.destroy6', $wait->id) }}" method="POST" class="d-none">
                           @csrf
                           @method('DELETE')
                       </form>

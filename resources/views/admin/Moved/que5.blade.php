          ...
          <div class="col-lg-6 col-7">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item"><a href="{{ route('que5.index') }}">Que5</a></li>
                <li class="breadcrumb-item active" aria-current="page">Queue 5</li>
              </ol>
            </nav>
          </div>
          <div class="col-lg-6 col-5 text-right">
            <a href="{{ route('que6.index') }}" class="btn btn-sm btn-neutral">QUEUE 6 </a>
            <a href="{{ route('que5.index') }}" class="btn btn-sm btn-neutral">BACK TO QUE 5</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col">
        <div class="card">
          ...
          <div class="card-header border-0">
            <h3 class="mb-0">QUEUE 5 PAYOUT LIST</h3>
          </div>
          <!-- Light table -->
          <div class="table-responsive">
            ...
            <table class="table">
              ...
              <tbody>
                @foreach ($que5moved as $index => $wait)
                  <tr>
                    ...
                    <div class="form-group">
                      <label for="text">QUEUE 1 SPACE REWARD:</label> <input class="form-control" name="amount" placeholder="AMOUNT" type="text" value="62500" required="">
                    </div>
                    <div class="form-group">
                      ...
                      <button class="btn btn-success btn-md btn-block" type="submit">Submit</button>
                                ...
                                <form id="update-form-{{ $wait->id }}" action="{{ route('que5moved.update5', $wait->id) }}" method="POST" class="">
                                  @csrf
                                  @method('PUT')
                              ...
                              <div class="modal-footer">
                                ...
                                <a class="btn btn-info" href="{{ route('que5moved.update5', $wait->id) }}"
                       ...
                       <form id="delete-form-{{ $wait->id }}" action="{{ route('que5moved.destroy5', $wait->id) }}" method="POST" class="d-none">
                           @csrf
                           @method('DELETE')
                       </form>

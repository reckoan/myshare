          ...
          <div class="col-lg-6 col-7">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item"><a href="{{ route('que1.index') }}">Que1</a></li>
                <li class="breadcrumb-item active" aria-current="page">Queue One</li>
              </ol>
            </nav>
          </div>
      ...
      <div class="col">
        <div class="card">
          ...
          <div class="card-header border-0">
            <h3 class="mb-0">QUEUE 1 PAYOUT LIST</h3>
          </div>
          <!-- Light table -->
          <div class="table-responsive">
            ...
            <table class="table">
              ...
              <tbody>
                @foreach ($que1moved as $index => $wait)
                  <tr>
                    ...
                    <div class="form-group">
                      <label for="text">QUEUE 1 SPACE REWARD:</label> <input class="form-control" name="amount" placeholder="AMOUNT" type="text" value="100" required="">
                    </div>
                    <div class="form-group">
                      ...
                      <button class="btn btn-success btn-md btn-block" type="submit">Submit</button>
                                ...
                                <form id="update-form-{{ $wait->id }}" action="{{ route('que1moved.update1', $wait->id) }}" method="POST" class="">
                                  @csrf
                                  @method('PUT')
                              ...
                              <div class="modal-footer">
                                ...
                                <a class="btn btn-info" href="{{ route('que1moved.update1', $wait->id) }}"
                       ...
                       <form id="delete-form-{{ $wait->id }}" action="{{ route('que1moved.destroy1', $wait->id) }}" method="POST" class="d-none">
                           @csrf
                           @method('DELETE')
                       </form>
                          ...
                          <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <a class="btn btn-danger" href="{{ route('que1moved.destroy1', $wait->id) }}"
                                  onclick="event.preventDefault();

            ...
            <div class="header bg-primary pb-6">
                <div class="container-fluid">
                  <div class="header-body">
                    <h2 class="text-center m-t-4" style="text-align: center; color:#fff; padding-top: 24px;">CHECK YOUR PAYOUTS PAY-OUT STATUS 1 LIST</h2>
                              ...
                              <div class="col">
                                <div class="card">
                                  ...
                                  <div class="card-header border-0">
                                    <h3 class="mb-0">Q1-PAY-OUT STATUS</h3>
                                  </div>
                                  <!-- Light table -->
                                  <div class="table-responsive">
                                    ...
                                    <tbody>
                                      @foreach ($payouts1 as $index =>  $pay1)

            ...
            <div class="header bg-primary pb-6">
                <div class="container-fluid">
                  <div class="header-body">
                    <h2 class="text-center m-t-4" style="text-align: center; color:#fff; padding-top: 24px;">CHECK YOUR PAYOUTS PAY-OUT STATUS 5 LIST</h2>
                              ...
                              <div class="col">
                                <div class="card">
                                  ...
                                  <div class="table-responsive">
                                    ...
                                    <tbody>
                                      @foreach ($payouts5 as $index =>  $pay1)

            ...
            <div class="header bg-primary pb-6">
                <div class="container-fluid">
                  <div class="header-body">
                    <h2 class="text-center m-t-4" style="text-align: center; color:#fff; padding-top: 24px;">CHECK YOUR QUEUE 5 LIST STATUS</h2>
                              ...
                              <div class="col">
                                <div class="card">
                                  ...
                                  <div class="card-header border-0">
                                    <h3 class="mb-0">QUEUE 5 FOR UPGRADE</h3>
                                  </div>
                                  <!-- Light table -->
